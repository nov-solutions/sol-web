...
export default function Team({
    ...
    const teamCardsHTML = 
        ...
        ? team.map((teammate, i) => (
            <div key={i} className={"flex flex-col items-center justify-center w-full p-4 text-center rounded-lg lg:p-8 aspect-square " + teamCardBG}>
  ...
  return (
    <div className={"flex-grow px-4 py-12 lg:px-0 " + teamBG}>
      <div className="grid items-center gap-4 mx-auto lg:grid-cols-5 lg:w-2/3">
        {teamCardsHTML}
      </div>
    </div>
  );
