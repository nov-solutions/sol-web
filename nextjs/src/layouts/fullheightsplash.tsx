...
export default function FullHeightSplash() {
  return (
    <div className="flex justify-center flex-grow px-4 pb-24 bg-white pt-36 lg:pt-48 lg:px-0">
      <div className="grid items-center gap-16 mx-auto lg:grid-cols-2 lg:w-2/3">
        <div className="flex flex-col items-center space-y-4 text-center lg:items-start lg:text-left">
          ...
          <h2 className="font-medium lg:text-lg text-gray">
            TODO
          </h2>
          <a
            href="TODO"
            className="text-left text-white w-fit btn btn-primary"
          >
            TODO
          </a>
        </div>
