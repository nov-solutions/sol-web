  ...
  return (
    <div className={"px-4 py-24 lg:px-0 " + featureDetailsBG}>
      <div className="flex flex-col items-center mx-auto space-y-4 lg:w-2/3">
        ...
        <div className="grid grid-cols-1 place-items-center !mt-8 gap-8 lg:grid-cols-3">
          <div className="flex flex-col w-3/4 p-8 space-y-2 rounded-lg lg:w-auto">
            <h4 className={"font-semibold " + detailsTitleColor}><i className="mr-2 align-middle material-icons">{detailOneIcon}</i>{detailOneTitle}</h4>
            <p className={"text-sm" + detailsDescriptionColor}>{detailOneDescription}</p>
          </div>
          <div className="flex flex-col w-3/4 p-8 space-y-2 rounded-lg lg:w-auto">
            <h4 className={"font-semibold " + detailsTitleColor}><i className="mr-2 align-middle material-icons">{detailTwoIcon}</i>{detailTwoTitle}</h4>
            <p className={"text-sm" + detailsDescriptionColor}>{detailTwoDescription}</p>
          </div>
          <div className="flex flex-col w-3/4 p-8 space-y-2 rounded-lg lg:w-auto">
            <h4 className={"font-semibold " + detailsTitleColor}><i className="mr-2 align-middle material-icons">{detailThreeIcon}</i>{detailThreeTitle}</h4>
